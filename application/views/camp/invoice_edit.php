...
<script type='text/javascript'></script> 
    ...
    <input type="radio" class="d-print-none" name="play"  value="Preshow"  <?php if ($WF == 'Preshow') {echo ' checked ';} ?> />Preshow</label>
<input type="radio"  class="d-print-none"  name="play"  value="During intravel" <?php if ($WF == 'During intravel') {echo ' checked ';} ?> />During intravel</label>
