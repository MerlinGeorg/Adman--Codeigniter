...
<script type='text/javascript'></script> 
                <div class="card-header"><h5>INVOICE</h5>Invoice # 2018-2019/MPIBSA/00<?php echo $estimate_num = $estrow->invo_id; ?></strong>
    ...
    <input type="radio" class="d-print-none addrow" name="play"  value="Preshow"  <?php if ($WF == 'Preshow') {echo ' checked ';} ?> />Preshow</label>
<input type="radio"  class="d-print-none addrow"  name="play"  value="During intravel" <?php if ($WF == 'During intravel') {echo ' checked ';} ?> />During intravel</label>
...
>
                  ...
                  <td class="text-left"><button type="submit" class="btn btn-warning">Remove</button></td></form> -->
                        ...
                        <form method="post" >
                              ...
                              <td class="d-print-none addrow"></form>
