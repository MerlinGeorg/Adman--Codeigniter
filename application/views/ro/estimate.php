...
<?php //$this->load->view('ro/header_menu.php'); ?>
 <div id="wrapper">
  ...
  <li ><a href="<?php echo site_url('camp/create_camp'); ?>"><i class="fa fa-bar-chart-o fa-fw"></i>Create Campaign</a>                          
						...
						<li style="background-color: #DDDDDD;"><a href="<?php echo site_url('camp/list_estimates'); ?>"><i class="fa fa-bar-chart-o fa-fw"></i>Estimates</a>                          
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Estimates</h4>
					                </div>
 <!-- /////////////////////////////////////////////////////////.panel-body -->     
  <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead style="font-size: 12px; color: #337ab7; ">
                                        <tr>
                                          <th>ID</th>       
                                            <th>CAMP NAME</th>                                               
                                            <th>CREATED</th>
      ...
      <?php  foreach ($estlist->result() as $estrow) { ?>
                  ...
                  <td><a href="<?php  echo site_url('camp/camp_edit').'/'.$estrow->est_id ; ?>" target="_blank">Edit</a>
                                        </td></tr>
	  <?php } ?>
