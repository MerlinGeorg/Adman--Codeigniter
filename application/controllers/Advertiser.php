...
$this->form_validation->set_rules('phone_1', 'Phone-1', 'numeric|required|xss_clean');
$this->form_validation->set_rules('phone_2', 'Phone-2', 'numeric|xss_clean');
$this->form_validation->set_rules('wphone', 'Wphone', 'numeric|xss_clean');
				...
				{ 
					...
					$cr_date = date("Y/m/d") ;
					$adv_data = array(	'adv_name'=>$this->input->post('adv_name'),
...
$cr_date = date("Y/m/d") ;
					$adv_dataup = array(	'adv_name'=>$this->input->post('adv_name'),
										 		'c_person' => $this->input->post('c_person'),
										 		'city' => $this->input->post('city'),
										 		'phone_1' => $this->input->post('phone_1'),
										 		'phone_2' => $this->input->post('phone_2'),
